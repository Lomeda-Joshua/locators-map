                ...
                <div className = "sub-content container">
                    <div className = "col-md-12 justify-content-center" >
                            ...
                            <div className = "sub-content container">
                                ...
                                <p id = "descriptionNPQSD">The (NPQSD) of the Bureau of Plant Industry is the regulatory arm of the Philippine Department of Agriculture when it comes to matters of import, export, domestic movement, as well as market access of plants and plant products. 
                                </p>
                            </div>
