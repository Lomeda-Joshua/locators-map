...
export default function Home(){
    return(
        ...
        <div className = "sub-content container" >
            <div class="row row-grid align-items-start" style={{ margin:"23px"}}>

                <div class="col-lg-7">
                        <div className="box--text" style={{backgroundColor:"#fcb04f", width:"70%", padding:"10px"}}>
                ...
                <div class="col-lg-4">
                        <img style={{maxWidth:"100%", width:"400px"}} src="./assets/img/maps/manila_layout_v1.png" />
                </div>
            </div>
        </div>
        ...
        <div className = "sub-content container" >
            <div class="row row-grid align-items-start" style={{ margin:"24px"}}>
                ...
                <div class="col-lg-9">
                    ...
                    <button type="button" class="btn btn-success btn-round">to locators map</button>
                </div>
        ...
        <div className = "sub-content container">
                ...
                <h3 style ={{ textTransform:"uppercase", fontSize:"23px", fontWeight:"600"}}>grab a copy of the locators map brochure at the information and computer section</h3>
