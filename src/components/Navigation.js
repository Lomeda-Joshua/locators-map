            ...
            <div class="navbar-collapse collapse" id="navbar_global">
              ...
              <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
                        <i class="ni ni-collection d-lg-none"></i>
                        <span class="nav-link-inner--text">Locators Map</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
                        <i class="ni ni-collection d-lg-none"></i>
                        <span class="nav-link-inner--text">Division Profiles</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
                        <i class="ni ni-collection d-lg-none"></i>
                        <span class="nav-link-inner--text">Inquiries</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" data-toggle="dropdown" href="#" role="button">
              ...
              <li class="nav-item">
                ...
                <li class="nav-item">
                    <a href="locators-map" class="nav-link" data-toggle="dropdown"  role="button">
                        {/* <i class="ni ni-collection d-lg-none"></i> */}
                        <span class="nav-link-inner--text">Locators Map</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="division-profiles" class="nav-link" data-toggle="dropdown"  role="button">
                        {/* <i class="ni ni-collection d-lg-none"></i> */}
                        <span class="nav-link-inner--text">Division Profiles</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="inquiries" class="nav-link" data-toggle="dropdown" role="button">
                        {/* <i class="ni ni-collection d-lg-none"></i> */}
                        <span class="nav-link-inner--text">Inquiries</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="contact-us" class="nav-link" data-toggle="dropdown"  role="button">
                        {/* <i class="ni ni-collection d-lg-none"></i> */}
                        <span class="nav-link-inner--text">Contact Us</span>
                    </a>
                </li>
